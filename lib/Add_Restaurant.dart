...
class _AddRestaurantScreenState extends State<AddRestaurantScreen> {
  ...
  Future<void> _sendApiRequest(Restaurant newRestaurant) async {
    ...
    final Map<String, dynamic> requestBody = {
      ...
      "open_Close_Time": getCombinedTime(),
      "offdays": jsonEncode(newRestaurant.offDays), // Combine selected days into a single string
      "resturant_type": newRestaurant.type,
      "business_Id": businessController.text,
      "licesnes_Id": licenseController.text,
